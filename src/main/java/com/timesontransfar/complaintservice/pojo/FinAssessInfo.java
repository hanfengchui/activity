...
public class FinAssessInfo {
	
	private TsSheetQualitative qualitative;
	private TScustomerVisit customerVisit;
	...
	public TsSheetQualitative getQualitative() {
		return qualitative;
	}
	public void setQualitative(TsSheetQualitative qualitative) {
		this.qualitative = qualitative;
	}
	public TScustomerVisit getCustomerVisit() {
		return customerVisit;
	}
	public void setCustomerVisit(TScustomerVisit customerVisit) {
